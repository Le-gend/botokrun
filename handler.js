...
╭֍〔 𝐀𝐂𝐂𝐄𝐒𝐒 𝐃𝐄𝐍𝐈𝐄𝐃 〕֍─
⬡    
⬡ Command Only Moderator
╰────────────֍`,
        premium: `${nmsr}\n
╭֍〔 𝐀𝐂𝐂𝐄𝐒𝐒 𝐃𝐄𝐍𝐈𝐄𝐃 〕֍─
⬡    
⬡ Command Only Premium User
╰────────────֍`,
        group: `${nmsr}\n
╭֍〔 𝐀𝐂𝐂𝐄𝐒𝐒 𝐃𝐄𝐍𝐈𝐄𝐃 〕֍─
⬡    
⬡ Command Only In Group
╰────────────֍`,
        private: `${nmsr}\n
╭֍〔 𝐀𝐂𝐂𝐄𝐒𝐒 𝐃𝐄𝐍𝐈𝐄𝐃 〕֍─
⬡    
⬡ Command Only Private Chat
╰────────────֍`,
        admin: `${nmsr}\n
╭֍〔 𝐀𝐂𝐂𝐄𝐒𝐒 𝐃𝐄𝐍𝐈𝐄𝐃 〕֍─
⬡    
⬡ Command Only Admin Group
╰────────────֍`,
        botAdmin: `${nmsr}\n
╭֍〔 𝐀𝐂𝐂𝐄𝐒𝐒 𝐃𝐄𝐍𝐈𝐄𝐃 〕֍─
⬡    
⬡ Bot Must Make Admin Group
╰────────────֍`,
        nsfw: `${nmsr}\n
NSFW tidak aktif, !`,
        rpg: `${nmsr}\n
...
Fitur ini di *disable* !`
    ...
    if (msg) return conn.sendButton(m.chat, danied, msg, `${imgr + 'Cant Run This Command'}`, [['MENU', '.menu'],['OWNER', '.owner']],m)
    
     let msgg = {
    	unreg: `${nmsr}\nSilahkan Daftar ke database terlebih dahulu untuk menggunakan bot ini lebih lanjut *Click button di bawah*\n\n*Kalian bisa ikuti langkah Daftar selanjutnya* ?`
}[type]
if (msgg) return conn.sendButton(m.chat, `${global.htki} DAFTAR ${global.htka}`, msgg, `${imgr + 'Verify'}`, [['DAFTAR', '/verify']],m)
}    
