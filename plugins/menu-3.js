...
let handler = async (m, { conn, usedPrefix, __dirname }) => {
  try {
    ...
    const menu = './thumbnail.jpg'
    const valor = './thumbnail.jpg'
    let url = 'https://i.ibb.co/gZ9XgjF/thumbnail.jpg'
...
`, text.trim(), `${flaa}All Menu`, [
      ...
      [`۪۪DONASI`, `${usedPrefix}owner`]
    ], m, {
contextInfo: { externalAdReply :{ showAdAttribution: true,
                        sourceUrl: 'https://wa.me/6283180588257',
                        mediaType: 2,
                        description: "Runtime " + uptime,
                        title: "Runtime " + uptime,
                        body: bottime,
                        thumbnail: await (await fetch(logo)).buffer(),
                        mediaUrl: 'https://youtu.be/qgOMSRtxo5g'
