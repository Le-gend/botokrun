...
if (command == 'ceksifat') {
await conn.sendButton(m.chat, cksft, author, logo, [['🎀 Menu', '/menu']], m, { mentions: conn.parseMention(cksft), fileLength: fsizedoc, seconds: fsizedoc, contextInfo: {
          externalAdReply :{
    mediaUrl: sig,
    mediaType: null,
    description: wm, 
  ...
  await conn.sendButton(m.chat, msdpn, author, logo, [['🎀 Menu', '/menu']], m, { mentions: conn.parseMention(msdpn), fileLength: fsizedoc, seconds: fsizedoc, contextInfo: {
          externalAdReply :{
    mediaUrl: sig,
    mediaType: null,
    description: wm, 
