...
let Poto = fs.readFileSync('./media/dusk.jpg')
...
conn.send2ButtonImg(m.chat, Poto, krtu, weem, 'Menu', '.menu', 'Owner', '.owner', m, { contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: 'https://www.instagram.com/nand.10',
    mediaType: 2, 
    description: sgc,
    title: 'Jᴏɪɴ Sɪɴɪ Cᴜʏ',
    body: bottime,
